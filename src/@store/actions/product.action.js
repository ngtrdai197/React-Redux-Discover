...
const getAllProductSucess = product => {
  return {
    type: rootActions.GET_ALL_PRODUCT_SUCCESS,
    payload: product
  };
};
const getAllProductFail = error => {
  return {
    type: rootActions.GET_ALL_PRODUCT_FAIL,
    payload: error
  };
};
...
const getProductSucess = product => {
  return {
    type: rootActions.GET_PRODUCT_ID_SUCCESS,
    payload: product
  };
};
const getProductFail = error => {
  return {
    type: rootActions.GET_PRODUCT_ID__FAIL,
    payload: error
  };
};
